...
class Setting(BaseSettings):
    ...
    desc: str = "Tool to map content of JSON-LD documents (for example output of [CSVtoCSVW](https://github.com/Mat-O-Lab/CSVToCSVW) to Entities in knowledge graphs by creating mapping rules with conditions in [YARRRML](https://rml.io/yarrrml) format."
